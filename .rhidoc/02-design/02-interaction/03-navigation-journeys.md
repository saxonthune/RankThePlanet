...
A **journey** is an ordered sequence of navigation events a user expects to be able to take, starting from a named surface. The source of truth is the rhidoc sidecar `03-navigation.journeys.json` — a flat fact-shaped record of journeys and steps.
